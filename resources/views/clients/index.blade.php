										  ...
										  @foreach ($clients as $client)
												<tr>
													...
													<td>
															...
															<a href="{{ route('tests.edit',$client->id) }}" class="btn btn-primary btn-xs", data-toggle="tooltip" title="Editar" data-remote='true'])>   <i class="fa fa-edit"></i>
																</a>
